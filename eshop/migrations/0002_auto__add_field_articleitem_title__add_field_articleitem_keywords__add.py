...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'ArticleItem.title'
        db.add_column('eshop_articleitem', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ArticleItem.keywords'
        db.add_column('eshop_articleitem', 'keywords',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ArticleItem.descriptions'
        db.add_column('eshop_articleitem', 'descriptions',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ArticleCategory.title'
        db.add_column('eshop_articlecategory', 'title',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ArticleCategory.keywords'
        db.add_column('eshop_articlecategory', 'keywords',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)

        # Adding field 'ArticleCategory.descriptions'
        db.add_column('eshop_articlecategory', 'descriptions',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=255, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'ArticleItem.title'
        db.delete_column('eshop_articleitem', 'title')

        # Deleting field 'ArticleItem.keywords'
        db.delete_column('eshop_articleitem', 'keywords')

        # Deleting field 'ArticleItem.descriptions'
        db.delete_column('eshop_articleitem', 'descriptions')

        # Deleting field 'ArticleCategory.title'
        db.delete_column('eshop_articlecategory', 'title')

        # Deleting field 'ArticleCategory.keywords'
        db.delete_column('eshop_articlecategory', 'keywords')

        # Deleting field 'ArticleCategory.descriptions'
        db.delete_column('eshop_articlecategory', 'descriptions')
