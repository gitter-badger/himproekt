...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'ArticleItem', fields ['slug']
        db.create_unique('eshop_articleitem', ['slug'])


    def backwards(self, orm):
        # Removing unique constraint on 'ArticleItem', fields ['slug']
        db.delete_unique('eshop_articleitem', ['slug'])
